...
class Todo{
    ...
    render(){
        ...
        this.entries.forEach((entryValue, entryIndex)=>{
            ...
            div.innerHTML = `<div class="titleValue">${entryValue.title}</div><div class="descriptionValue">${entryValue.description}</div><div class="dateValue">${entryValue.date}<br>${entryValue.time}</div>`;
